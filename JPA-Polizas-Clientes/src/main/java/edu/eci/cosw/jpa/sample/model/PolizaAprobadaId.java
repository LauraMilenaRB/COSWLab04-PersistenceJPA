...
public class PolizaAprobadaId  implements java.io.Serializable {
    ...
    @Column(name="CLIENTES_id", nullable = false, length = 11)
    private int clientesId;


    @Column(name="CLIENTES_tipo_id", nullable = false, length = 11)
    private String clientesTipoId;

    @Column(name="POLIZAS_codigo_poliza", nullable = false, length = 11)
